...
server.registerTool("check_crm_cli_status", {
...
server.registerTool("search_crm_projects", {
...
server.registerTool("get_crm_project_detail", {
...
server.registerTool("lookup_crm_users", {
...
server.registerTool("preaudit_approval_with_crm", {
...
}, async (args) => textResult(await connectorRequest("/approvals/preaudit/crm", {
    method: "POST",
    body: JSON.stringify(args)
})));
